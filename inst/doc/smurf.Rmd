...
All functions will be illustrated using a dataset with rent prices for Munich residences in 2003. The goal is to predict the monthly rent per square meter, based on a set of predictors. Since this data was studied previously by @gertheiss2010, the predictors are pre-treated in the same way. 
